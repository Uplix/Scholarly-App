...
export default function ItemScreen({route}){
    ...
    const cancelEvent = async ()=>{
        ...
        setLoading(true);
        await context.deleteFromSchedule(route.params.object);
        setLoading(false);
    ...
    return(
        <SafeAreaView style={{flex:1, flexDirection:"column"}}>
            <ScrollView>
                ...
                <TouchableOpacity onPress={()=>setCancelModal(true)} style={styles.cancelButton} activeOpacity={.75}>
            ...
            <Modal visible={cancelModal} onBackdropPress={()=>setCancelModal(false)} style={styles.modal} backdropStyle={{backgroundColor: 'rgba(0, 0, 0, 0.5)',}} animationType="fade">
                <Text style={styles.modalText}>Are you sure you want to cancel your session? This action cannot be undone.</Text>
                <View style={styles.modalButtonContainer}>
                    ...
                    <TouchableOpacity onPress={cancelEvent} activeOpacity={.75} style={{
                        ...styles.modalButton, 
